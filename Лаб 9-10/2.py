...
winner = """Имя победителя: {% if sp.chperone|length>sp.chpertwo|length%}{{sp.spname_one}}.
Характеристика победителя:{{sp.chperone}}.
Вид соревнования:{{sp.tpsport}}.
Дата проведения: {{date.strftime("%d/%m/%y")}}.{% elif sp.chperone|length<sp.chpertwo|length%}{{sp.spname_two}}.
Характеристика победителя:{{sp.chpertwo}}.
Вид соревнования:{{sp.tpsport}}.
Дата проведения: {{date.strftime("%d/%m/%y")}}.
{% elif sp.chperone|length==sp.chpertwo|length %}Имя победителя:{{n}}.Вид соревнования:{{sp.tpsport}}.Дата проведения:{{date.strftime("%d/%m/%y")}}{% endif %}"""
